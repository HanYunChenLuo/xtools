...
> 最后更新：2026-09-23：路径审计收官——主机工具二进制解析四缺口全修（`XPERF_SCRCPY`/`XPERF_TRACE_PROCESSOR`/`XPERF_CHROME` env 覆盖 + scrcpy ≥2 版本门槛 + `/tmp/trace_processor` 硬编码改 temp_dir 双候选），AGENTS.md 主机工具解析表成文；I 节 scrcpy 版本地板提示 ✅
